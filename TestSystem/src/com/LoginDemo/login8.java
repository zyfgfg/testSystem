 ...
 *
 */
public class login8 extends JFrame {
    ...
    Student[] student;
    private static JFrame frame = new JFrame("删除学员");
...
//        this.setLocationRelativeTo(null);
        ...
        JLabel userLabe2 = new JLabel("删除学员");
        ...
        loginButton5.setBounds(420, 270, 100, 30);
        ...
        loginButton.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                Student student = new Student(sx, (String) null);
                try {
